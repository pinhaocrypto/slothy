...
- AArch64: Cortex-A55 and, experimentally, Cortex-A76, Cortex-A72, Cortex-X/Neoverse-V, Apple M1 (Firestorm, Icestorm)
...
SLOTHY supports Python 3.10 up to 3.14. For development Python >= 3.11 is required.
